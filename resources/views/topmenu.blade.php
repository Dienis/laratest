@if(!isset($innerLoop))
  <nav class="navbar navbar-toggleable-md navbar-inverse bg-inverse topmenu">
    ...
    <div class="container">
      ...
      <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#calculationOfCost">
                  Расчет стоимости
                </button>
    </span>
    </div>
